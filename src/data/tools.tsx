...
import {
  LayersIcon, SplitSquareHorizontalIcon, MinimizeIcon, RotateCwIcon,
  PickaxeIcon, LockIcon, UnlockIcon, ShieldIcon,
  ScissorsIcon, TrashIcon, FileTextIcon, ImageIcon, CodeIcon, PenToolIcon, WrenchIcon, TypeIcon, FileBadgeIcon
